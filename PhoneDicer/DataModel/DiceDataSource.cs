...
namespace PhoneDicer.Data
{
	...
	public class DiceDataSource
	{
		...
		private ObservableCollection<DiceDataGroup> _groups = new ObservableCollection<DiceDataGroup>();

		public ObservableCollection<DiceDataGroup> Groups
		{
		...
		private async Task GetDiceDataAsync()
		{
			if (this._groups.Count != 0)
				return;
			Uri dataUri = new Uri("ms-appx:///DataModel/DiceData.json");
